...
export const metadata: Metadata = {
  title: "Roasted Bliss Coffee - Artisanal Coffee & Premium Beans",
  description: "Experience exceptional coffee at Roasted Bliss. From signature lattes to premium coffee beans, discover your perfect cup in our cozy coffee shop atmosphere.",
  keywords: "coffee shop, artisanal coffee, premium coffee beans, latte, espresso, cold brew, coffee roasting",
  metadataBase: new URL("https://roastedbliss.coffee"),
  alternates: {
    canonical: "https://roastedbliss.coffee"
  },
  openGraph: {
    title: "Roasted Bliss Coffee - Where Every Sip Tells a Story",
    description: "Experience exceptional coffee at Roasted Bliss. From signature lattes to premium coffee beans, discover your perfect cup in our cozy coffee shop atmosphere.",
    siteName: "Roasted Bliss",
    images: [{
